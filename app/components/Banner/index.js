            ...
            <Swiper style={styles.brand_wrapper} 
                  ...
                  >
				  {
								this.state.categories.map((item, index) => {
									...
									return(
										<View style={styles.h_banner}>
											<Image 
										style={styles.h_banner_image}
									 source={{uri: item.image,width: width, height: width*85/150}}/>
...
const styles = StyleSheet.create({
  ...
  brand_wrapper:{
	 height: width*85/150+ 50, 
  },
  h_banner_text_container:{
	position: 'absolute',
	top:width*0.40,
	marginLeft:15,
  },
